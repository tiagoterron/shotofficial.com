...
var Skype = new function () {
		...
		function l(L) {
			...
			z.setAttribute("style", ("border:0; margin:10px; vertical-align:" + this.assetSizeMap[("size" + this.assetSize)].verticalOffset + "px;"));
			if (this.name === this.dropdownLinks.name) {
				...
				N.setAttribute("style", "cursor: text;margin:0px !important;");
			...
			if (this.name === this.dropdownLinks.name) {
				...
				I.innerHTML = "Call S.H.O.T.";
				t.appendChild(I);
				E.innerHTML = "Chat to S.H.O.T.";
				Q.appendChild(E);
				r.appendChild(t);
				r.appendChild(Q);
