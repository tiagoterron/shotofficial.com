...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../_images/_uploads/upload/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../_images/_uploads/upload/');	//accept relative path only
