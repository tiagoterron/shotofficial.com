...
$filter = "(a.t_name LIKE '%".$txt_search."%' OR a.t_email LIKE '%".$txt_search."%')";
...
//TABELA E COLUNAS
$tabela = "tb_newsletter a";
$cols = array('ID{20}'=>'id{a}', 'Name{200}'=>'t_name{a}', 'E-mail{300}'=>'t_email{a}', 'Date{150}'=>'dt_cad{a}');
...
<div class="manage-content-menu">
	<ul>
        <li class="current"><a href="<?php echo PATH.$pag_atual ?>">REGISTERED</a><div class="right">&nbsp;</div></li>
        <li><a href="<?php echo PATH ?>manage/newsletter-tab_three/">SEND E-MAIL</a><div class="right">&nbsp;</div></li>
    </ul>
</div>
...
<label>title/e-mail: </label>
    ...
    <div class="top-titulo"><?php echo "0".$quantreg; ?> e-mails <br /><img src="<?php echo PATH ?>_images/manage/hr.jpg" /></div>
...
<ul class="label">
	...
	switch($c){
	case "id":
	$fetch_atual = $nn++;/*sprintf('%04d', html_entity_decode($SQL_Q["id"])) ;*/
	break;
	case "dt_cad":
	...
	?>
    <li class="w150"><span class="l"><?php /*?><a href="<?php echo PATH ?>manage/newsletter-send-email/<?php echo $SQL_Q["id"]?>">ENVIAR E-MAIL</a> | <?php */?><a href="<?php echo PATH ?>manage/exec/newsletter-delete/<?php echo $SQL_Q["id"]?>">APAGAR</a></span></li>
    <div style="clear:both;"></div>
    </ul>
    <?php
	}
...
$pag_atual = preg_replace("/\/[0-9]$/", "", $pag_atual);
