...
<div class="manage-content-menu">
	<ul>
    	<li class="current"><a href="<?php echo PATH ?>manage/eventos-tab_one/">UPCOMING</a><div class="right">&nbsp;</div></li>
...
<label>date/location/venue: </label>
    ...
    <div class="top-titulo">Upcoming<br /><img src="<?php echo PATH ?>_images/manage/hr.jpg" /></div>
