...
$filter = "(a.nome LIKE '%".$txt_search."%' OR a.video LIKE '%".$txt_search."%')";	
}else{
$filter = "1=1";	
}
...
//TABELA E COLUNAS
$tabela = "tb_videos a";
$cols = array('ID{20}'=>'id{a}', 'Video{125}'=>'video{a}', 'Title{250}'=>'nome{a}', 'Main{50}'=>'main{a}', 'Status{750}'=>'status{a}', 'Date{125}'=>'dt_cad{a}');
...
$SQL_PAG = "SELECT *, $columns FROM $tabela WHERE $filter ORDER BY a.id DESC LIMIT $inicial,$numreg";
...
<div class="manage-content-menu">
	<ul>
        <li class="current"><a href="<?php echo PATH.$pag_atual ?>">VIDEOS</a><div class="right">&nbsp;</div></li>
    </ul>
</div>
...
<label>title: </label>
    ...
    <div class="top-titulo">Videos<br /><img src="<?php echo PATH ?>_images/manage/hr.jpg" /></div>
...
<ul class="label">
	...
	break;
	case "dt_cad":
	$fetch_atual = html_entity_decode($SQL_Q["dt_cad"]);
	break;
	case "nome":
	$fetch_atual = html_entity_decode($SQL_Q["nome"]);
	break;
	case "main":
	$fetch_atual = html_entity_decode($SQL_Q["main"])=="Y"?"<span style='color:#FF0000;'>YES</span>":"NO";
	break;
	case "video":
	$fetch_atual = html_entity_decode($SQL_Q["video"]);
	$fetch_atual = explode("v=", $fetch_atual);
	$fetch_atual = explode("&", $fetch_atual[1]);
	$fetch_atual = $fetch_atual[0];
	$fetch_atual = "<img src=\"http://i1.ytimg.com/vi/$fetch_atual/default.jpg\" width=\"125px\" />";
	break;
	case "status":
	...
	?>
    <li class="w225"><span class="l"><a href="<?php echo PATH ?>manage/videos-tab_adicionar/edit/<?php echo $SQL_Q["id"]?>">EDIT</a> | <?php if($SQL_Q["status"]=="on"){?><a href="<?php echo PATH ?>manage/exec/video-tab_two-set-stats/<?php echo $SQL_Q["id"]?>/off/">OFFLINE</a><?php }else{ ?><a href="<?php echo PATH ?>manage/exec/video-tab_two-set-stats/<?php echo $SQL_Q["id"]?>/on/">ONLINE</a><?php } ?> | <a href="<?php echo PATH ?>manage/exec/delete-videos-tab_one/<?php echo $SQL_Q["id"]?>">DELETE</a></span></span></li>
    <div style="clear:both;"></div>
    </ul>
    <?php
	}
	...
	?>
<div class="both"></div>
<div class="manage_btn_adicionar"><a href="<?php echo PATH ?>manage/videos-tab_adicionar/"><img src="<?php echo PATH ?>_images/manage/btn-adicionar.jpg" class="manage_btn_adicionar" /></a></div>
<div class="paginacao">
