<?php
header("Location: http://shotofficial.com/onlineshop");
?>
        ...
        <label class="title"><h2>Shop Online <?php echo $t_cat_tit; ?></h2><div style="float:right;margin:5px;"><a href="javascript:void(0)" onclick="close_tab('store_box_1')">[+]</a></div></label>
		...
		<li>
			<div class="<?php echo $class_cd; ?>">
				...
				if($t_quantidade == 0){
				?>
                <img src="<?php echo PATH ?>_images/sold-out.png" width="150px" style="position:absolute;margin-top:20px;" />
                <?php
				}
				?>
                <a href="<?php echo PATH ?>view-product/<?php echo $t_tit_cat.$t_url; ?>"><img src="<?php echo PATH ?>_images/_uploads/_thumbs/min_<?php echo $t_imagem; ?>" alt="<?php echo BAND ?> - Merchandise (<?php echo $t_titulo; ?>)" title="<?php echo BAND ?> - Merchandise (<?php echo $t_titulo; ?>)" id="id_select_tshirt_<?php echo $t_id; ?>" /></a></div><div style="display:none;" id="id_t_shirt_<?php echo $t_id; ?>"></div>
                <div class="right_infos_store"><h4><a href="<?php echo PATH ?>view-product/<?php echo $t_tit_cat.$t_url; ?>"><?php echo $t_titulo; ?></a></h4>
                <div class="both"></div>
            ...
            <a href="<?php echo PATH ?>view-product/<?php echo $t_tit_cat.$t_url; ?>"><img class="icon_de_add" src="<?php echo PATH ?>_images/icon_details.jpg" /></a>
            <?php
				if($t_quantidade == 0){
				?>
           <img class="icon_de_add" src="<?php echo PATH ?>_images/icon_add_to_cart_sold.jpg" /><div class="both"></div>
            <?php
			}else{
			?>
             <a href="javascript:void(0)" onclick="add_to_cart(<?php echo $t_id; ?>, '<?php echo $_SESSION["id_user_on"]; ?>', '<?php echo $s_t_shirt;?>', '<?php echo session_id(); ?>')"><img class="icon_de_add" src="<?php echo PATH ?>_images/icon_add_to_cart.jpg" /></a><div class="both"></div></div>
            <?php
			}
			?>
                </div>
