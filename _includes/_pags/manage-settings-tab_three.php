...
$filter = "(a.t_name LIKE '%".$txt_search."%' OR a.t_email)";
...
//TABELA E COLUNAS
$tabela = "tb_users a";
$cols = array('ID{20}'=>'id{a}', 'Name{300}'=>'t_name{a}', 'E-mail{300}'=>'t_email{a}', 'Level{100}'=>'manage{a}');
...
$SQL_PAG = "SELECT $columns FROM $tabela WHERE $filter ORDER BY a.dt_cad DESC LIMIT $inicial,$numreg";
...
<div class="manage-content-menu">
	<ul>
        ...
        <li class="current"><a href="<?php echo PATH ?>manage/settings-tab_three/">ADMINISTRATORS</a><div class="right">&nbsp;</div></li>
    </ul>
</div>
...
<label>name/e-mail: </label>
    ...
    <div class="top-titulo">Administrators<br /><img src="<?php echo PATH ?>_images/manage/hr.jpg" /></div>
...
<ul class="label">
	...
	break;
	case "manage":
	$fetch_atual = html_entity_decode($SQL_Q["manage"]);
	if($fetch_atual == "Y") $fetch_atual = "MANAGE"; else $fetch_atual = "USER";
 	break;
	default:
	...
	?>
    <li class="w150"><span class="l"><a href="<?php echo PATH ?>manage/settings-tab_three_add/edit/<?php echo $SQL_Q["id"]?>">EDIT</a> | <a href="<?php echo PATH ?>manage/exec/settings-three-delete/<?php echo $SQL_Q["id"]?>">DELETE</a></span></li>
    <div style="clear:both;"></div>
    </ul>
    <?php
	}
	...
	?>
    <div class="both"></div>
<div class="manage_btn_adicionar"><a href="<?php echo PATH ?>manage/settings-tab_three_add/"><img src="<?php echo PATH ?>_images/manage/btn-adicionar.jpg" class="manage_btn_adicionar" /></a></div>
<div style="clear:both;"></div>
<div class="paginacao">
