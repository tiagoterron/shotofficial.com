...
//TABELA E COLUNAS
$tabela = "tb_albuns a";
$cols = array('ID{20}'=>'id{a}', 'Image{125}'=>'imagem{a}', 'Title{150}'=>'nome{a}', 'N° photos{75}'=>'[n_fotos]{a}', 'Clicks{50}'=>'clicks{a}', 'Status{75}'=>'status{a}', 'Last Update{125}'=>'dt_update{a}');
...
<div class="manage-content-menu">
	<ul>
        <li class="current"><a href="<?php echo PATH.$pag_atual ?>">PHOTOS</a><div class="right">&nbsp;</div></li>
    </ul>
</div>
...
<label>title: </label>
    ...
    <div class="top-titulo">Photos<br /><img src="<?php echo PATH ?>_images/manage/hr.jpg" /></div>
...
<ul class="label">
	...
	break;
	case "[n_fotos]":
	$fetch_atual = sprintf('%04d', mysql_result(mysqli_query($connect, "SELECT count(*) FROM tb_fotos WHERE id_album = ".html_entity_decode($SQL_Q["id"])), 0, 0));
	break;
	case "dt_cad":
	$fetch_atual = html_entity_decode($SQL_Q["dt_cad2"]);
	break;
	case "imagem":
	$fetch_atual = "<img class='pic_album_manage' src='".PATH."_images/_uploads/imgs/_thumbs/min_".html_entity_decode($SQL_Q["imagem"])."' width='125px' />";
	break;
	case "date":
	...
	?>
    <li class="w200"><span class="l"><a href="<?php echo PATH ?>manage/fotos-tab_one_adicionar/edit/<?php echo $SQL_Q["id"]?>">EDIT</a> | <?php if($SQL_Q["status"]=="on"){?><a href="<?php echo PATH ?>manage/exec/fotos-tab_two-set-stats/<?php echo $SQL_Q["id"]?>/off/">OFFLINE</a><?php }else{ ?><a href="<?php echo PATH ?>manage/exec/fotos-tab_two-set-stats/<?php echo $SQL_Q["id"]?>/on/">ONLINE</a><?php } ?> | <a href="<?php echo PATH ?>manage/exec/delete-fotos-tab_one/<?php echo $SQL_Q["id"]?>">DELETE</a></span></span></li>
    <div style="clear:both;"></div>
    </ul>
    <?php
	}
	...
	?>
<div class="both"></div>
<div class="manage_btn_adicionar"><a href="<?php echo PATH ?>manage/fotos-tab_one_adicionar/"><img src="<?php echo PATH ?>_images/manage/btn-adicionar.jpg" class="manage_btn_adicionar" /></a></div>
<div class="paginacao">
